...
export const ResearchView: React.FC<ResearchViewProps> = ({ initialQuery, onQueryHandled, t, language, onDeductTokens }) => {
    ...
    const sendMessage = useCallback(async (messageText: string) => {
        ...
        try {
            ...
            if (modelResponse.usage) onDeductTokens(modelResponse.usage);
    ...
    }, [isLoading, t, language, onDeductTokens]);
