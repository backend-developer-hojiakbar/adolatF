...
export const TimelineView: React.FC<TimelineViewProps> = ({ caseData, onUpdateTimeline, t, language }) => {
    ...
    const handleGenerateTimeline = async () => {
        ...
        try {
            ...
            const newEvents = await generateTimeline(caseData.caseDetails, caseData.files, t as any, language);
